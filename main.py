...
if __name__ == '__main__':
    ...
    for epoch in range(1,args.epochs+1):
        ...
        loss_logger.log_losses('valid.log',epoch,valid_loss,valid_metrics,valid_loss_unk, param_group['lr'], middle)
        ...
        # loss_logger.log_losses('test.log',epoch,test_loss,test_metrics,test_loss_unk, param_group['lr'], 0) 
