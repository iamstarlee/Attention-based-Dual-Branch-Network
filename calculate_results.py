...
def calculateResults(args):
    ...
    # targetSplitpath = 'binary_results/after.csv'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_path", type=str, default = "./metric_results")
    parser.add_argument("--split", type=str, default = "Val", choices=["Train", "Val", "Test"])
    parser.add_argument("--score_path", type=str, default = "./sigmoid_results")
